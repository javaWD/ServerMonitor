...
import cn.com.esrichina.ServerMonitor.domain.Services;

/**
 * Home object for domain model class Services.
 * @see cn.com.esrichina.ServerMonitor.dao.Services
...
public class ServicesHome {
	...
	public Services merge(Services detachedInstance) {
		...
		try {
			Services result = (Services) sessionFactory.getCurrentSession()
	...
	public Services findById(long id) {
		...
		try {
			Services instance = (Services) sessionFactory.getCurrentSession()
					.get("cn.com.esrichina.ServerMonitor.dao.Services", id);
			if (instance == null) {
	...
	public List findByExample(Services instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria(
							"cn.com.esrichina.ServerMonitor.dao.Services")
