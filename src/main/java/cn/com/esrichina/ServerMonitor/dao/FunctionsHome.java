...
import cn.com.esrichina.ServerMonitor.domain.Functions;

/**
 * Home object for domain model class Functions.
 * @see cn.com.esrichina.ServerMonitor.dao.Functions
 * @author Hibernate Tools
 */
public class FunctionsHome {

	private static final Log log = LogFactory.getLog(FunctionsHome.class);
	...
	public void persist(Functions transientInstance) {
		log.debug("persisting Functions instance");
		try {
	...
	public Functions merge(Functions detachedInstance) {
		...
		try {
			Functions result = (Functions) sessionFactory.getCurrentSession()
	...
	public Functions findById(long id) {
		...
		try {
			Functions instance = (Functions) sessionFactory.getCurrentSession()
					.get("cn.com.esrichina.ServerMonitor.dao.Functions", id);
			if (instance == null) {
	...
	public List findByExample(Functions instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria(
							"cn.com.esrichina.ServerMonitor.dao.Functions")
