...
import cn.com.esrichina.ServerMonitor.domain.Groups;

/**
 * Home object for domain model class Groups.
 * @see cn.com.esrichina.ServerMonitor.dao.Groups
	...
	public Groups findById(long id) {
		...
		try {
			Groups instance = (Groups) sessionFactory.getCurrentSession().get(
					"cn.com.esrichina.ServerMonitor.dao.Groups", id);
			if (instance == null) {
	...
	public List findByExample(Groups instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria("cn.com.esrichina.ServerMonitor.dao.Groups")
