...
import cn.com.esrichina.ServerMonitor.domain.Users;

/**
 * Home object for domain model class Users.
 * @see cn.com.esrichina.ServerMonitor.dao.Users
	...
	public Users findById(long id) {
		...
		try {
			Users instance = (Users) sessionFactory.getCurrentSession().get(
					"cn.com.esrichina.ServerMonitor.dao.Users", id);
			if (instance == null) {
	...
	public List findByExample(Users instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("cn.com.esrichina.ServerMonitor.dao.Users")
