...
import cn.com.esrichina.ServerMonitor.domain.Config;

/**
 * Home object for domain model class Config.
 * @see cn.com.esrichina.ServerMonitor.dao.Config
...
public class ConfigHome {
	...
	public Config merge(Config detachedInstance) {
		...
		try {
			Config result = (Config) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Config findById(long id) {
		...
		try {
			Config instance = (Config) sessionFactory.getCurrentSession().get(
					"cn.com.esrichina.ServerMonitor.dao.Config", id);
			if (instance == null) {
	...
	public List findByExample(Config instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria("cn.com.esrichina.ServerMonitor.dao.Config")
