...
import cn.com.esrichina.ServerMonitor.domain.Media;

/**
 * Home object for domain model class Media.
 * @see cn.com.esrichina.ServerMonitor.dao.Media
...
public class MediaHome {
	...
	public Media merge(Media detachedInstance) {
		...
		try {
			Media result = (Media) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Media findById(long id) {
		...
		try {
			Media instance = (Media) sessionFactory.getCurrentSession().get(
					"cn.com.esrichina.ServerMonitor.dao.Media", id);
			if (instance == null) {
	...
	public List findByExample(Media instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("cn.com.esrichina.ServerMonitor.dao.Media")
