...
import cn.com.esrichina.ServerMonitor.domain.Images;

/**
 * Home object for domain model class Images.
 * @see cn.com.esrichina.ServerMonitor.dao.Images
...
public class ImagesHome {
	...
	public Images merge(Images detachedInstance) {
		...
		try {
			Images result = (Images) sessionFactory.getCurrentSession().merge(
					detachedInstance);
	...
	public Images findById(long id) {
		...
		try {
			Images instance = (Images) sessionFactory.getCurrentSession().get(
					"cn.com.esrichina.ServerMonitor.dao.Images", id);
			if (instance == null) {
	...
	public List findByExample(Images instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria("cn.com.esrichina.ServerMonitor.dao.Images")
