...
import cn.com.esrichina.ServerMonitor.domain.Events;

/**
 * Home object for domain model class Events.
 * @see cn.com.esrichina.ServerMonitor.dao.Events
	...
	public Events findById(long id) {
		...
		try {
			Events instance = (Events) sessionFactory.getCurrentSession().get(
					"cn.com.esrichina.ServerMonitor.dao.Events", id);
			if (instance == null) {
	...
	public List findByExample(Events instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria("cn.com.esrichina.ServerMonitor.dao.Events")
